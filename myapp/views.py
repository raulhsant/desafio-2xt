...
def list_quotations(request):
    ...
    for quotation in quotations:
        quotation_dto_list.append(QuotationService.map_to_dto(quotation, product_list, client_info))
    return render(request, 'myapp/list.html', {"quotation_list": quotation_dto_list})



#TODO: save the buy action on the database!
#TODO: convert post_body to Sale object
def buy(request):
